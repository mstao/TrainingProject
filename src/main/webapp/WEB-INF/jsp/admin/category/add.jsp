...
$(function(){
	...
	$(".save").bind("click",function(){
		...
		if(type.replace(/(^s*)|(s*$)/g, "").length !=0 && flag.replace(/(^s*)|(s*$)/g, "").length !=0){
			//start
			$.ajax({
				type:'post',
				dataType:'text',
				url:CTPPATH+'/admin/category/save',
				data:{"itemType":type,"itemFlag":flag},
...
<label>栏目名称</label><br>
<input type="text"  placeholder="请填入栏目名称" class="type"><br><br>
<label>栏目标识</label><br>
<input type="text"  placeholder="请填入栏目标识" class="flag">
</div>
<div class="active">
